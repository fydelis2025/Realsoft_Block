            ...
            {                                
                ...
                for (int i = 0; i < Licenca.Length; i++)
                {
                    if (Licenca[i].LastIndexOf(".xml") > -1)
                    {
                        ...
                        //string retencript = Realsoft_Criptografia.Encrypt("server=REALSOFT;database=MONITORAMENTO;User=sa;Password=efeb1730fe92;Min Pool Size=20;Max Pool Size=100;", Realsoft_Parametros.passPhrase, Realsoft_Parametros.saltValue, Realsoft_Parametros.hashAlgorithm, Realsoft_Parametros._interacao, Realsoft_Parametros._initvector, Realsoft_Parametros.keySize);
                    }
                }                
            }                
            catch (Exception ex)
